...
<body class="bg-gray-100">
    ...
    <!-- Header -->
    <header class=" w-full border-b bg-white font-sans min-h-[60px] px-10 py-3 fixed m-0 tracking-wide z-50">
        <div class="flex flex-wrap items-center justify-between">
            <a href="#"><img src="https://readymadeui.com/readymadeui.svg" alt="logo" class="w-36" /></a>

            <nav class="hidden lg:flex space-x-8 items-center">
                <a href="#" class="text-gray-600 font-bold hover:text-blue-600">Home</a>
                <div class="relative group">
                    <a href="#" class="text-gray-600 font-bold hover:text-blue-600">Pages</a>
                    <div class="hidden absolute left-0 top-full mt-2 w-40 bg-white shadow-lg group-hover:block">
                        <a href="#" class="block px-4 py-2 text-gray-600 hover:bg-blue-50">Sub Page 1</a>
                        <a href="#" class="block px-4 py-2 text-gray-600 hover:bg-blue-50">Sub Page 2</a>
                    </div>
                </div>
                <div class="relative group">
                    <a href="#" class="text-gray-600 font-bold hover:text-blue-600">Blog</a>
                    <div class="hidden absolute left-0 top-full mt-2 w-40 bg-white shadow-lg group-hover:block">
                        <a href="#" class="block px-4 py-2 text-gray-600 hover:bg-blue-50">Blog Post 1</a>
                        <a href="#" class="block px-4 py-2 text-gray-600 hover:bg-blue-50">Blog Post 2</a>
                    </div>
                </div>
                <a href="#" class="text-gray-600 font-bold hover:text-blue-600">Team</a>
                <a href="#" class="text-gray-600 font-bold hover:text-blue-600">About</a>
                <a href="#" class="text-gray-600 font-bold hover:text-blue-600">Contact</a>
            </nav>

            <!-- Search Bar -->
            <div class="hidden lg:flex bg-gray-100 border rounded-full h-10 items-center px-4">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-gray-500 mr-2"
                ...
                <input type="text" placeholder="Search..."
                    class="w-full bg-transparent text-gray-600 outline-none font-semibold text-sm" />
            </div>
        </div>

        <!-- Mobile Menu -->
        <div class="lg:hidden">
            <nav class="flex flex-col space-y-3 mt-3">
                <a href="#" class="text-gray-600 font-bold hover:text-blue-600">Home</a>
                <a href="#" class="text-gray-600 font-bold hover:text-blue-600">Pages</a>
                <a href="#" class="text-gray-600 font-bold hover:text-blue-600">Blog</a>
                <a href="#" class="text-gray-600 font-bold hover:text-blue-600">Team</a>
    ...
    <!-- Hero Section -->
<!-- Section -->
<section class="container mx-auto pt-[80px] p-4">
    @foreach ($data['data'] as $news)
        <div class="bg-white rounded-lg shadow-md p-6 flex flex-col md:flex-row items-center">
            <img src="{{ $news['image']['small'] }}" alt="Berita Utama" class="w-full md:w-1/2 rounded-lg md:mr-6">
            <div class="mt-4 md:mt-0 md:ml-6">
                ...
                <a href="#" class="mt-4 inline-block bg-indigo-500 text-white py-2 px-4 rounded hover:bg-indigo-600">Baca
                    Selengkapnya</a>
            </div>
        </div>
    @break
        ...
        <div
            ...
            <div class="lg:mx-auto text-left ">
                ...
                <ul class="text-sm  transition-all duration-500">
                    ...
                    <li class="mb-6"><a href="javascript:;"
                            class=" text-gray-600 hover:text-gray-900">Pricing</a></li>
            ...
            <div class="lg:mx-auto text-left ">
                ...
                <ul class="text-sm  transition-all duration-500">
                    ...
                    <li class="mb-6"><a href="javascript:;" class=" text-gray-600 hover:text-gray-900">Icons
                            Assets</a></li>
                    <li class="mb-6"><a href="javascript:;"
                            class=" text-gray-600 hover:text-gray-900">Responsive Blocks</a></li>
